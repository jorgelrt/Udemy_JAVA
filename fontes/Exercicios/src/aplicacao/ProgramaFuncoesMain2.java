...
public class ProgramaFuncoesMain2 { //aqui temos uma CLASSE
	...
	public static void main(String[] args) { //Já aqui temos uma FUNÇÃO enterpoint MAIN
		Scanner sc = new Scanner(System.in);
		Locale.setDefault(Locale.US);
		
		System.out.println("Informe 3 números separados por espaço");
		System.out.print(">>: ");
		...
		System.out.printf("O maior número informado foi: %.2f",resultado);
